...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div style="background-image: url(<?php the_post_thumbnail_url(); ?>); padding: 40rem 0 0 0; background-size:103%; background-position:top center; margin-bottom:2.25rem; background-repeat:no-repeat;" data-stellar-background-ratio="0.3">
